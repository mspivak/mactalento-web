...
class Cmsms_Content_Composer { 
	function __construct() { 
		...
		register_activation_hook(__FILE__, 'cmsms_content_composer_activate');
		
		register_deactivation_hook(__FILE__, 'cmsms_content_composer_deactivate');
...
";
	...
	function cmsms_content_composer_activate() {
		flush_rewrite_rules();
	}
	
	
	function cmsms_content_composer_deactivate() {
		flush_rewrite_rules();
	}
}
