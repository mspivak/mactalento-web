...
<div class="tribe-events-meta-group tribe-events-meta-group-details">
	<h2 class="tribe-events-single-section-title"><?php esc_html_e('Details', 'econature'); ?></h2>
	<div class="cmsms_event_meta_info">
		...
		?>
			<div class="cmsms_event_meta_info_item">
				<span class="cmsms_event_meta_info_item_title"><?php esc_html_e('Start:', 'econature'); ?></span>
			...
			<div class="cmsms_event_meta_info_item">
				<span class="cmsms_event_meta_info_item_title"><?php esc_html_e('End:', 'econature'); ?></span>
				<span class="cmsms_event_meta_info_item_descr">
		...
		elseif ( tribe_event_is_all_day() ):
			?>
			<div class="cmsms_event_meta_info_item">
				<span class="cmsms_event_meta_info_item_title"><?php esc_html_e('Date:', 'econature'); ?></span>
				<span class="cmsms_event_meta_info_item_descr">
					<abbr class="tribe-events-abbr updated published dtstart" title="<?php echo esc_attr($start_ts); ?>"><?php echo esc_html($start_date); ?></abbr>
				</span>
			</div>
		...
		// Single day events
			...
			<div class="cmsms_event_meta_info_item">
				<span class="cmsms_event_meta_info_item_title"><?php esc_html_e('Time:', 'econature'); ?></span>
				<span class="cmsms_event_meta_info_item_descr">
		...
		if (!empty($cost)): ?>
			<div class="cmsms_event_meta_info_item">
				<span class="cmsms_event_meta_info_item_title"><?php esc_html_e('Cost:', 'econature') ?></span>
		...
		$cmsms_event_tags = tribe_meta_event_tags( sprintf( __( '%s Tags:', 'econature' ), tribe_get_event_label_singular() ), ', ', false );
		
		if ($cmsms_event_tags) {
			echo '<div class="cmsms_event_meta_info_item cmsms_event_tags">' . 
				'<dl>' . tribe_meta_event_tags( sprintf( __( '%s Tags:', 'econature' ), tribe_get_event_label_singular() ), ', ', false ) . '</dl>' . 
			'</div>';
		}
		...
		if (!empty($website)): ?>
			<div class="cmsms_event_meta_info_item">
				...
				<span class="cmsms_event_meta_info_item_descr tribe-events-event-url"><?php echo wp_kses_post($website); ?></span>
			</div>
		<?php endif;
