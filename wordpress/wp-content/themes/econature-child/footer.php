	...
	?>">
		...
		<?php 
			...
			'</span>' . "\n";
                ...
                echo '<br><br><a href="https://servicios1.afip.gov.ar/clavefiscal/qr/response.aspx?qr=8tIqlZgbAt757qe-8UvIzg" target="_blank"><img class="afip-data-fiscal" src="' . esc_url(get_template_directory_uri()) . '-child/img/datafiscal-mactalento.png"></a>';
		?>
			</div>
		</div>
	</footer>
